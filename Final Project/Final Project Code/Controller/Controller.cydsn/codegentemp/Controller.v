...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1600000, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=100000, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR_1, CY_INSTANCE_SHORT_NAME=ADC_SAR_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.3 CP3, INSTANCE_NAME=ADC_SAR_1, )
module ADC_SAR_v3_0_1 (
	...
	cy_clock_v1_0
		#(.id("18bc4843-ae73-4951-b999-2ce07c87945b/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module ADC_SAR_v3_0_2 (
	...
	cy_clock_v1_0
		#(.id("788fe08c-4d63-426b-a604-acd513c8e560/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625000000"),
		  .is_direct(0),
...
module UART_v2_50_3 (
	...
	cy_clock_v1_0
		#(.id("543d6dbd-be2b-4c22-ab87-7101cd1befa6/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("13020833333.3333"),
		  .is_direct(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("913412ce-60e8-42d2-8367-18145da92fdf"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("35ec9177-dbab-4432-94e6-c1acd1bce914"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9aee7f97-6db9-4cd1-ad41-4491b7459c15"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c2ccc3ef-d01d-4de4-8b20-128ab4078bc8"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ff3234c1-5733-499d-b6db-b1ae3efcd6c1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("ace2c545-a89c-45d4-a3d8-e7cb1cf3c1ea"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("709ce711-a20b-4f4f-a194-2d7d1199a5d1"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c0940237-5cb7-4c93-8497-72f127ec566c"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b2e4f2c0-f302-4053-b2d6-3ab55f7a74af"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__B4_net;
	wire [0:0] tmpIO_0__B4_net;
	wire [0:0] tmpINTERRUPT_0__B4_net;
	electrical [0:0] tmpSIOVREF__B4_net;

	cy_psoc3_pins_v1_10
		#(.id("b6cf1055-c24d-43d7-8790-b53a370d0a10"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		...
		B4
		 (.oe(tmpOE__B4_net),
		  .y({1'b0}),
		  .fb({Net_112}),
		  .io({tmpIO_0__B4_net[0:0]}),
		  .siovref(tmpSIOVREF__B4_net),
		  .interrupt({tmpINTERRUPT_0__B4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("02c2d70b-d066-477a-92af-396b8a637f24"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    UART_v2_50_3 UART_2 (
        ...
        .reset(1'b0),
        .rx(Net_133),
        .tx_interrupt(Net_145),
        .rx_interrupt(Net_146),
        .tx_data(Net_147),
        .tx_clk(Net_148),
        .rx_data(Net_149),
        .rx_clk(Net_150));
	...
	cy_psoc3_pins_v1_10
		#(.id("7b963374-ee20-4d90-ab68-3732f0a051cc"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("89eff866-7931-437b-a796-8e8892319940"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
