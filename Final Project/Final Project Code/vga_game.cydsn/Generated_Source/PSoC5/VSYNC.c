...
void VSYNC_Init(void) 
{
        ...
        ctrl = VSYNC_CONTROL & ((uint8)(~VSYNC_CTRL_CMPMODE2_MASK)) & ((uint8)(~VSYNC_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
		...
		*******************************************************************************/
		void VSYNC_SetCompareMode(uint8 comparemode) 
		{
		        ...
		        /*Clear existing mode */
		        VSYNC_CONTROL &= ((uint8)(~(VSYNC_CTRL_CMPMODE1_MASK | VSYNC_CTRL_CMPMODE2_MASK))); 
...
void VSYNC_WritePeriod(uint8 period) 
{
    ...
    *******************************************************************************/
    uint8 VSYNC_ReadStatusRegister(void)   
    {
    	...
    	result = CY_GET_REG8(VSYNC_STATUS_PTR);
    	return (result);
    }
