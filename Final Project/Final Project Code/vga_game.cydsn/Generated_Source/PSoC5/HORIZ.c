...
void HORIZ_Init(void) 
{
        ...
        ctrl = HORIZ_CONTROL & ((uint8)(~HORIZ_CTRL_CMPMODE2_MASK)) & ((uint8)(~HORIZ_CTRL_CMPMODE1_MASK));
    ...
    /* Globally disable the Fixed Function Block chosen */
		...
		*******************************************************************************/
		void HORIZ_SetCompareMode(uint8 comparemode) 
		{
		        ...
		        /*Clear existing mode */
		        HORIZ_CONTROL &= ((uint8)(~(HORIZ_CTRL_CMPMODE1_MASK | HORIZ_CTRL_CMPMODE2_MASK))); 
...
void HORIZ_WritePeriod(uint8 period) 
{
    ...
    *******************************************************************************/
    uint8 HORIZ_ReadStatusRegister(void)   
    {
    	...
    	result = CY_GET_REG8(HORIZ_STATUS_PTR);
    	return (result);
    }
