...
#define VERT_INIT_INTERRUPTS_MODE     (uint8)(((uint8)(0u << VERT_STATUS_TC_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << VERT_STATUS_CMP2_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << VERT_STATUS_CMP1_INT_EN_MASK_SHIFT )) | \
                                                  (uint8)((uint8)(0u << VERT_STATUS_KILL_INT_EN_MASK_SHIFT )))
...
******************************** */
    ...
    ***********************************/
    ...
    #define VERT_CTRL_CMPMODE1_SHIFT    0x04u  /* As defined by Register map as MODE_CFG bits in CFG2*/
    
    #define VERT_CTRL_DEAD_TIME_SHIFT   0x06u   /* As defined by Register map */

    /* Fixed Function Block Only CFG register bit definitions */
    #define VERT_CFG0_MODE              0x02u   /*  Set to compare mode */
    
    /* #define VERT_CFG0_ENABLE            0x01u */  /* Enable the block to run */
    #define VERT_CFG0_DB                0x20u   /* As defined by Register map as DB bit in CFG0 */
    ...
    #define VERT_STATUS_TC_SHIFT            0x07u   /* As defined by Register map as TC in SR0 */
    #define VERT_STATUS_CMP1_SHIFT          0x06u   /* As defined by the Register map as CAP_CMP in SR0 */
    ...
    #define VERT_RT1_MASK              (uint8)((uint8)0x03u << VERT_RT1_SHIFT)/* Sync TC and CMP bit masks */
    #define VERT_SYNC                  (uint8)((uint8)0x03u << VERT_RT1_SHIFT)
    #define VERT_SYNCDSI_SHIFT         0x00u
    #define VERT_SYNCDSI_MASK          (uint8)((uint8)0x0Fu << VERT_SYNCDSI_SHIFT) /* Sync all DSI inputs */
    #define VERT_SYNCDSI_EN            (uint8)((uint8)0x0Fu << VERT_SYNCDSI_SHIFT) /* Sync all DSI inputs */
