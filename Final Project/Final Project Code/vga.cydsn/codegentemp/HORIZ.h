...
#define HORIZ_INIT_INTERRUPTS_MODE     (uint8)(((uint8)(0u << HORIZ_STATUS_TC_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << HORIZ_STATUS_CMP2_INT_EN_MASK_SHIFT)) | \
                                                  (uint8)((uint8)(0u << HORIZ_STATUS_CMP1_INT_EN_MASK_SHIFT )) | \
                                                  (uint8)((uint8)(0u << HORIZ_STATUS_KILL_INT_EN_MASK_SHIFT )))
...
******************************** */
    ...
    ***********************************/
    ...
    #define HORIZ_CTRL_CMPMODE1_SHIFT    0x04u  /* As defined by Register map as MODE_CFG bits in CFG2*/
    
    #define HORIZ_CTRL_DEAD_TIME_SHIFT   0x06u   /* As defined by Register map */

    /* Fixed Function Block Only CFG register bit definitions */
    #define HORIZ_CFG0_MODE              0x02u   /*  Set to compare mode */
    
    /* #define HORIZ_CFG0_ENABLE            0x01u */  /* Enable the block to run */
    #define HORIZ_CFG0_DB                0x20u   /* As defined by Register map as DB bit in CFG0 */
    ...
    #define HORIZ_STATUS_TC_SHIFT            0x07u   /* As defined by Register map as TC in SR0 */
    #define HORIZ_STATUS_CMP1_SHIFT          0x06u   /* As defined by the Register map as CAP_CMP in SR0 */
    ...
    #define HORIZ_RT1_MASK              (uint8)((uint8)0x03u << HORIZ_RT1_SHIFT)/* Sync TC and CMP bit masks */
    #define HORIZ_SYNC                  (uint8)((uint8)0x03u << HORIZ_RT1_SHIFT)
    #define HORIZ_SYNCDSI_SHIFT         0x00u
    #define HORIZ_SYNCDSI_MASK          (uint8)((uint8)0x0Fu << HORIZ_SYNCDSI_SHIFT) /* Sync all DSI inputs */
    #define HORIZ_SYNCDSI_EN            (uint8)((uint8)0x0Fu << HORIZ_SYNCDSI_SHIFT) /* Sync all DSI inputs */
